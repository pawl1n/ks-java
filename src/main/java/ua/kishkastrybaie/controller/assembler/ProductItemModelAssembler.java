...
public class ProductItemModelAssembler implements RepresentationModelAssembler<ProductItem, ProductItemDto> {
    ...
    @Override
    @NonNull
    public CollectionModel<ProductItemDto> toCollectionModel(@NonNull Iterable<? extends ProductItem> productItems) {
         return RepresentationModelAssembler.super.toCollectionModel(productItems)
