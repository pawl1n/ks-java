...
public class OrderItemModelAssembler implements RepresentationModelAssembler<OrderItem, OrderItemDto> {
    ...
    @Override
    @NonNull
    public CollectionModel<OrderItemDto> toCollectionModel(@NonNull Iterable<? extends OrderItem> orderItems) {
        return RepresentationModelAssembler.super.toCollectionModel(orderItems)
